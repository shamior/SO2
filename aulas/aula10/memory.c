...
// Recupera o índice (L2, L1 ou L0) do endereço virtual de acordo com o nível
// Formato do VA: |L2 | L1 | L0| offset|,  onde L2 = L1 = L0 = 9 bits e offset = 12 bits.
int
page_idx(uint64 va, int level) {
    return (va >> (PAGE_SHIFT + level * 9)) & PAGE_IDX_MASK;
}

// Retorna o endereço físico (end. de pág) a partir do número de página física armazenado em uma PTE
// A PTE ocupa 64 bits:
